...
function db_compare_main($db_compare_config = [])
{
    ...
    $db_config = [
      'db_host' => $db_compare_config['host'],
      'db_name' => $db_compare_config['name'],
      'db_user' => $db_compare_config['user'],
      'db_pwd'  => $db_compare_config['pwd'],
      'db_port' => $db_compare_config['port'] ?: 3306,
    ];
    $db1 = new_db($db_config);
    $name = $db_compare_config['name'];
...
function db_compare_sync_like($db_compare_config, $need_sync_dbs = [])
{
    ...
    $c = [
      'db_host' => $db_compare_config['host'],
      'db_name' => trim($db_compare_config['name']),
      'db_user' => $db_compare_config['user'],
      'db_pwd'  => $db_compare_config['pwd'],
      'db_port' => $db_compare_config['port'] ?: 3306,
    ];
